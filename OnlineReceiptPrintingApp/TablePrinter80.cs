    ...
    public class TablePrinter80
    {
        ...
        */
        ...
        public static float PrintDetailTable(Graphics graphics, PrintPageEventArgs e, PrintDocument pd, float yPos, dynamic products)
        {
            ...
            string[] headers = { "DESCRIPCION", "CANT", "PRECIO", "IMPORTE" };
            ...
            foreach (var fila in products)
            {
                ...
                decimal subtotal = Convert.ToDecimal(fila.quantity) * Convert.ToDecimal(fila.sale_price);
                ...
                g.DrawString(App.moneyFormat(fila.sale_price), font, Brushes.Black, new RectangleF(leftMargin + columnWidths[0] + columnWidths[1], y, columnWidths[2], lineHeight), formatPrice);
                ...
                {
                    int length = Math.Min(20, descripcion.Length - start);
